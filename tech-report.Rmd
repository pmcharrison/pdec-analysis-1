...
We demonstrate the application of this model to recent data from sequence detection paradigms [e.g. @Barascud2016],
...
```{r, cache = TRUE, fig.cap = "Four example decay functions. a) Null decay function, corresponds to original PPM algorithm. b) As in A, but with a short-term learning rate of a = 0.75. c) As in B, but with a short-term memory half-life of c = 50. d) As in C, but with a long-term learning rate of d = 0.1."}
f <- list(decay_none, 
